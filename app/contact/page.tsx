...
type FormValues = {
  ...
  job_title: string;
  company_name: string;
  help: "Evaluate Degi for my company" | "Brand Service" | "Get a Quote" | "Other";
  services:
    | "Mobile App Develoment"
    | "Social Media Marketing"
    | "UI/UX Design"
          ...
          <div
            className="
              ...
              text-gray-300
                    "
          >
            Let&apos;s talk about how Degi can help your team work better.
          </div>
          ...
          {!submitted ? (
            ...
            >
                  ...
                  <FormItem className="items-center justify-center w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Full Website Design">Full Website Design</SelectItem>
                      </SelectContent>
                    </Select>
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem className="items-center justify-center  w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        <div className="flex gap-4">
                          <SelectItem value="Evaluate Degi for my company">
                            Evaluate Degi for my company
                          </SelectItem>
                        </div>
                        <SelectItem value="Brand Service">Brand Service</SelectItem>
              ...
              <div className="flex gap-4 items-center">
                <div>
                  <Checkbox
                    className="outline border-2 border-gray-500 text-sm font-light bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400"
                  />
                </div>
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to Degi&apos; sending marketing communications related
                  to degi
                </div>
              </div>
            ...
            <>
              ...
              >
                <div className="w-80 py-20">
                  <PiSmiley className="text-6xl text-[#87819e] mx-auto" />
